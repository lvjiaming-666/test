...
- {id: FTFC0_CLK.outFreq, value: 80/3 MHz}
- {id: FTM0_CLK.outFreq, value: 40 MHz}
- {id: FTM1_CLK.outFreq, value: 40 MHz}
- {id: FTM2_CLK.outFreq, value: 40 MHz}
- {id: FTM3_CLK.outFreq, value: 40 MHz}
- {id: FlexIO0_CLK.outFreq, value: 40 MHz}
...
- {id: SPLLDIV1_CLK.outFreq, value: 40 MHz}
...
- {id: PCC.FTM1_CLK_SEL.sel, value: SCG.SPLLDIV1_CLK}
...
- {id: SCG.SPLLDIV1.scale, value: '4', locked: true}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    .scgConfig =
    {
        ...
        .spllConfig =
        {
            ...
            .src = 0U,
            .div1 = SCG_ASYNC_CLOCK_DIV_BY_4,     /* System PLL Clock Divider 1: divided by 4 */
