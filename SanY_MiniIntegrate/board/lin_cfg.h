...
#define SUPPORT_PROTOCOL_21     0U /* Equal to 1 when have at least one LIN2.1 or LIN2.2 interface */
...
#define SUPPORT_PROTOCOL_13     1U /* Equal to 1 when have at least one LIN1.3 interface */
...
/* frame buffer size */
#define LIN_FRAME_BUF_SIZE          7U
#define LIN_FLAG_BUF_SIZE           2U
...
#define LIN_LI0_Motor1LinError_FLAG_BIT_OFFSET    1U
